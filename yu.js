...
var isOnline = true;
// 要突破的技能
var topoText = '神龙东来,龙象般若功,冰月破魔枪,燎原百击,月夜鬼萧,孔雀翎,飞刀绝技,覆雨剑法,织冰剑法,翻云刀法,排云掌,如来神掌,释迦拈花指,拈花解语鞭,十怒蛟龙索,玄冥锤子,天火飞锤,四海断潮斩,昊天破周斧,玄天杖法,辉月杖法,破军棍诀,千影百伤棍,紫血大法,道种心魔经,生生造化功,万流归一,幽影幻虚步,十二都天神杖';
...
(function () {
    ...
    var xhts = {
        ...
        '京城': {
            ...
            "苦力京城": "进城找活路的苦力，衣着随便，满身灰尘。",
            "掌柜": "驿站的大掌柜，眼神深邃。",
            "醉汉京城": "赌坊里出来的醉汉，嘴里嘟嘟囔囔些什么，也许是一些赌坊的秘密。",
            "游客京城": "来京城游玩的外地人，对大城市的繁华目不暇接，满眼都是惊喜的神色。",
    ...
    var Jianshi = {qianlong: 0, GOQIANLONG: 0, tianjian: 0, jstimer: 0, qingzhengxie: 0, bangzhan: 0, bx: 0, sp: 0, sys: 1, renwu: 0, zhengxie: 0, teshu: 0, tf: 0, yx: 0, gw: 0, hd: 0, qx: 0, qxmj: 0, qxhg: 0, gensha: 0 };
    ...
    function beforeFightTongren() {
        ...
        // );
        // clickButton(
        //     "enableskill enable unarmed wuxiang-jingang-quan"
        // );
    ...
    function showQ() {
        ...
        out.each(function () {
            ...
            if (txt.indexOf('逃') != '-1') {
                ...
                indexTextKuFu = '【系统】' + kuafuNpc + '段老大逃到了'
    ...
    var chapList = ['雪亭镇', '洛阳', '华山村', '华山', '扬州', '丐帮', '乔阴县', '峨眉山', '恒山', '武当山',
        ...
        '白驮山', '嵩山', '梅庄', '泰山', '大旗门', '大昭寺', '魔教', '星宿海', '茅山', '桃花岛',
    ...
    var chapList = ['雪亭镇', '洛阳', '华山村', '华山', '扬州', '丐帮', '乔阴县', '峨眉山', '恒山', '武当山',
        ...
        '白驼山', '嵩山', '梅庄', '泰山', '大旗门', '大昭寺', '魔教', '星宿海', '茅山', '桃花岛',
    ...
    function makeMoreBtns() {
        ...
        digTreasureButton.className = 'btn-add btn-others';
        ...
        findSpecTargetButton.style.right = '90px';
    ...
    function doOnTime() {
        ...
        // 1、6、15 点
        if (hours == 1 || hours == 6 || hours == 8 || hours == 11 || hours == 13 || hours == 15) {
            hasDoOnece = false;
        }
        // 0点 成长
        if (hours == 0) {
    ...
    var skillsList = [
        ...
        // 剑法clickButton('tupo go,fuyu-sword', 1)
        {
            "name": "覆雨剑法",
            "id": "fuyu-sword",
            "who": "",
        ...
        // 掌法
        // clickButton('tupo go,shijianianhuazhi', 1)
        {
            "name": "释迦拈花指",
            "id": "shijianianhuazhi",
            "who": "",
        ...
        // 刀法clickButton('tupo go,fanyun-blade', 1)
        {
            "name": "翻云刀法",
            "id": "fanyun-blade",
            "who": "",
    ...
    function tupoSkills2() {
        ...
        // go('tupo go,wuxiang-jingang-quan'); //五行金刚拳
        // go('tupo go,shiyangjian');          //十阳灭冥箭
        // // go('tupo go,kunxianbianfa');     // 困仙辫法
        // go('tupo go,tongshouzhang');        // 龙渊玉英杖
    }
    ...
    function killGoodNpc(e) {
        var player = ['任侠', '暗刺', '金刀', '追命', '无花', '传鹰', '令东来', '西门吹雪', '石之轩', '朱大天王', '楚昭南', '阿青', '楚留香', '天山童姥', '乾罗', '令狐冲', '乔峰', '浪翻云','无『双』公主', '守楼虎将', '天剑真身', '王铁匠', '杨掌柜', '柳绘心', '客商', '卖花姑娘', '刘守财', '柳小花', '朱老伯', '方寡妇', '方老板'];
    ...
    function killBadNpc(e) {
        var player = ['石幽明', '胡铁花', '蒙赤行', '厉工', '叶孤城', '祝玉妍', '萧秋水', '凌未风', '白猿', '石观音', '李秋水', '方夜羽', '东方不败', '慕容博', '庞斑', '不『二』剑客', '攻楼死士', '天魔真身', '段老大', '二娘', '岳老三', '云老四', '剧盗', '恶棍', '流寇'];
    ...
    function isOneItem(name) {
        var itemArr = ['『秘籍木盒』', '玫瑰花', '乾坤袋', '突破丹礼包', '舞鸢尾', '狗粮', '保险卡'];
    ...
    function ZhanDouView() {
        this.dispatchMessage = function (b) {
            ...
            if (type == 'notice' || type == 'main_msg') {
                ...
                if (notice_msg.indexOf('帮派副本完成') >= 0) {
                ...
                if (notice_msg.indexOf('逃犯任务') < 0 && notice_msg.indexOf('获得') > 0 && notice_msg.indexOf('神鸢宝箱') > 0) {
                    // sendToQQ(notice_msg)
                }
                if (notice_msg.indexOf('逃犯任务') < 0 && notice_msg.indexOf('获得') > 0 && notice_msg.indexOf('白银宝箱') > 0) {
                    // sendToQQ(notice_msg)
                }
                ...
                if (notice_msg.indexOf('大显神威') > 0 && notice_msg.indexOf('[37区]大锤帮') > 0) {
                ...
                if (notice_msg.indexOf('开启了帮派副本') != '-1') {
                    // sendToQQ(notice_msg)
                }
            }
            if (type == 'channel') {
            ...
            if (Jianshi.bangzhan > 0) {
                ...
                if (msg.indexOf("帮派风云战") != "-1" && msg.indexOf('37区') != "-1" && msg.indexOf('镇守') != "-1") {
                    goBangZhan(msg);
                    return;
                }
            }
    ...
    function doLingPai() {
        go('home');
        go('jh 1');
        //clickButton('items get_store /obj/med/zhuangyuantie', 1)
        // clickButton('items get_store /obj/shop/zhengxieling', 1)
        // clickButton('items use obj_zhengxieling', 0)
    ...
    function goFastWay(){
        ...
        for (var i = 0; i < wayArr.length; i++){
            InforOutFunc(wayArr[i].name, wayArr[i].way, true)
        }
    }
    /**
     * 
     ...
     */
    var steps = 0;
    window.goFindNpcInPlace = function(w, name) {
        var go_path = '';
        if (w.startsWith("雪亭镇")) {
            ...
            go_path = "jh 6;event_1_98623439;ne;ne;ne;sw;sw;n;ne;ne;ne;sw;sw;sw;sw;s;w;e;n"
        ...
        if (go_path && !Jianshi.GOQIANLONG){
            Jianshi.GOQIANLONG = 1;
    ...
    function autoBang1Way(){
        let dir = 'n;w;w;w;e;e;e;e;e;e;w;w;w;n;w;w;w;e;e;e;e;e;e;w;w;w;n;w;w;w;e;e;e;e;e;e;w;w;w;n;w;w;w;e;e;e;e;e;e;w;w;w;n;w;w;w;e;e;e;e;e;e;w;w;w;n'
    ...
    function addTuBtn(txt) {
        ...
        var NPCNAME = txt.split('赐下')[1].split('VS')[0]
        if (killBadSwitch){
            NPCNAME = txt.split('VS')[1].split('三对')[0]
        }

        btnArr.forEach((item)=>{
            let goAction = "jh "+item.num
            InforOutFunc(item.name, goAction, true)
            InforOutFuncClick('寻找' + item.name, 'goFindNpcInPlace("' + item.name + '", "' + NPCNAME+'")')
        })
        if(Jianshi.qianlong){
            goFindNpcInPlace(btnArr[0].name, NPCNAME)
        }
    }
    // 加载完后运行
    $(function () {
    ...
    function reLoad() {
        ...
        if (disconnectDom.length > 0 && !hasSendReload) {
            ...
            if (nameObj[sendid]) {
                ...
                sendtext = 'Duang,' + sendqu + '区，' + sendid + '被顶下线了!';
                goInLine(sendtext)
            }
        }
    }
