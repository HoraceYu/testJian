...
(function() {
    ...
    async function clickButtonAsync(s) {
        ...
        async function interServerFn1(e){
            var skillsText = '九溪断月枪；千影百伤棍；破军棍诀；如来神掌；玄胤天雷；排云掌法';
        ...
        async function checkInList(){
            await clickButtonAsync('fudi houshan fetch');// 收后山
            await clickButtonAsync('fudi shennong fetch');// 收神农
            await clickButtonAsync('fudi juxian fetch_zhuguo'); // 收果子
            await clickButtonAsync('jh 1');        // 进入章节
            await clickButtonAsync('go west') ;     // 金庸
            await clickButtonAsync('event_1_46497436');
            ...
            if(Base.getCorrectText('4253282')){
                ...
                await clickButtonAsync('lq_bysf_lb');//谜题卡
            }
            ...
            await clickButtonAsync('tzjh_lq');   // 钱庄  clickButton('tzjh_lq', 1) touzi_jihua2 buygo 6
            await clickButtonAsync('touzi_jihua2 buygo 6');
        ...
        async function clickShuangDan1(){
            ...
            await clickButtonAsync('look_npc snow_xiaotangren');
        ...
        async function clickShuangEr(){
            ...
            // setTimeout(function (){clickXinChunLibaoBtn()},3000);
            await clickButtonAsync('jh 1');       // 进入扬州
            //clickButton('look_npc snow_zhounianxiaoer', 0)
            await clickButtonAsync('look_npc snow_zhounianxiaoer');
        ...
        function killQinglong(e){
            ...
            if(DomTxt == '杀青龙'){
                ...
                if(Base.getCorrectText('4254240')){
                    myCareList = "烛幽鬼煞锤,斩龙,小李飞刀";
                }
    
                if(Base.getCorrectText('4316804')){
                    myCareList = "烛幽鬼煞锤,斩龙宝镯,草,花,梅,木,菊,晚香玉,仙客来";
                }
                if(Base.getCorrectText('4316804') && Base.correctQu() == '38'){
                    myCareList = "斩龙宝靴,斩龙手镯,草,花,梅,木,菊,晚香玉,仙客来";
                }
    ...
    function kezhi(zhaoshi){ //1是剑法 2是拳法 3是刀法 4是暗器 5棍子 6枪
        ...
        async function tupoSkills2(){
            ...
            await clickButtonAsync('tupo go,kunxianbianfa');
            await clickButtonAsync('tupo go,huimengwuheng');
            await clickButtonAsync('tupo go,thfc');
        }
